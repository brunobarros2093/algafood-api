...
insert into cidade (id, nome_cidade, nome_estado) values (1, 'Uberlândia', 1);
insert into cidade (id, nome_cidade, nome_estado) values (2, 'Belo Horizonte', 1);
insert into cidade (id, nome_cidade, nome_estado) values (3, 'São Paulo', 2);
insert into cidade (id, nome_cidade, nome_estado) values (4, 'Campinas', 2);
insert into cidade (id, nome_cidade, nome_estado) values (5, 'Fortaleza', 3);
